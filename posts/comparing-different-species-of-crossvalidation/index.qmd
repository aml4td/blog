...
EDIT: based on the comments, [here](TODO) is one of the simulation files. I broke them up to run in parallel on our grid but they are all the same (except the seeds). [Here](TODO) is the markdown file for the post if you want the plot code or are interested to see how I summarized the results. 
