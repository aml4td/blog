...
`PPtree`s might do a better job when there are a few linear predictors that drive classification accuracy. This could have been demonstrated [using simulation of some sort](http://appliedpredictivemodeling.com/blog/2013/4/11/a-classification-simulation-system). 
